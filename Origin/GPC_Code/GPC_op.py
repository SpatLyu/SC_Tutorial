...
from distance_op import neighbors_op
...
def geo_pattern_causality(
    ...
    Mx, sMx, psMx= transtoM2(xMatrix, E, tau, metric, as_matrix=True, verbose=verbose)#, Dx 
    My, sMy, psMy = transtoM2(yMatrix, E, tau, metric, as_matrix=True, verbose=verbose)


    nearest_dis_x, nearest_index_x = neighbors_op(Mx, E,metric=metric,verbose=verbose)
